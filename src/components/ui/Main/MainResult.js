    ...
    <div className="app-main-text is-visible">
      ...
      {time > 0 ? (
        <div className="app-main-text-result">
          <p>
            <b>Количество знаков в тексте:</b> {symbols}
          </p>
          <p>
            <b>Количество слов в тексте:</b> {words}
          </p>
          <p>
            <b>Время чтения:</b> {timetring}
          </p>
          <p>
            <b>Скорость чтения:</b>{" "}
          ...
          <div className="app-main-text-result-book">
            ...
            <ResultLine
              ...
              day={countNumberDays(
                60,
                speedReadingWords,
                result.selectedItem[0].allWords
              )}
            />
          </div>
        </div>
